...
| 组件 | 固定版本 / 标识 |
|---|---|
| v0.2.0 / v0.2.0-rc1 内核源码基线 | `75982acf2d1a5708a654250b3b1f2462415fc1a9` |
| 公开发布分支 | `main` |
...
`v0.2.0` 没有相对 `v0.2.0-rc1` 修改内核源码或配置；二进制差异仅为等长发布标记。
...
|---|---|
| v0.2.0 / v0.2.0-rc1 kernel source baseline | `75982acf2d1a5708a654250b3b1f2462415fc1a9` |
...
`v0.2.0` changes neither kernel source nor configuration from `v0.2.0-rc1`;
the binary difference is limited to the equal-length release marker. The final
manifest records the tag commit after documentation and wrapper

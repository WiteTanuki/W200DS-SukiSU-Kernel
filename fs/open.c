...
#ifdef CONFIG_KSU
extern const struct cred *ksu_handle_faccessat(
...
long do_faccessat(int dfd, const char __user *filename, int mode)
{
	...
	const struct cred *ksu_old_cred = NULL;
...
#ifdef CONFIG_KSU
	ksu_old_cred = ksu_handle_faccessat(&dfd, &filename, &mode, NULL);
#endif
retry:

 ...
 * return -ENOENT if struct not defined
 */
 ...
 * return 0 if success
 * return -ENOENT if the struct or member is not defined
 * return -EINVAL if ptr or out_ptr is NULL
 */

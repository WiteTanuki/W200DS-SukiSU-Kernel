...
#define HWRST_STATUS_ZDT	0xaa
#define HWRST_STATUS_FZDT	0xa5
				    ...
				    unsigned long mode, void *cmd)
{
	...
	else if (!strncmp(cmd, "zdt", 3))
		reboot_mode = HWRST_STATUS_ZDT;
	else if (!strncmp(cmd, "fastzdt", 7))
		reboot_mode = HWRST_STATUS_FZDT;
